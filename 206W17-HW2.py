...
### You must arrange your code so that if you were to fail a test, 
### that would not cause any other tests to fail as a result of that test failing. (See lecture notes.)
...
### You may assume that other programmers will NOT invoke these functions with unacceptable inputs 
##(e.g. no one will try to create a card with rank 0). You just need to ensure that the code works as intended.
